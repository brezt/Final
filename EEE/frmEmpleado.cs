    ...
    private Boolean validarcampos()
    {
        ...
        private void btnguardar_Click(object sender, EventArgs e)
        {
            ...
            if (MessageBox.Show("SEGURO QUE DECEA MODIFICAR ESTE REGISTRO?", "ACTUALIZAR EMPLEADO", MessageBoxButtons.YesNoCancel, MessageBoxIcon.Question) == DialogResult.Yes) ;
            {
                ...
                op.ConsultasSinResultados("UPDATE Empleado SET Nombre ='" + txtnombre.Text + "', Apellido = '" + txtapellido.Text + "', Cedula = '"+txtcedula.Text+"', Nacionalidad = '"+txtNacionalidad.Text+"', Direccion='"+txtdireccion.Text+"', Telefono='"+txttelefono.Text+"', Correo= '"+txtCorreo.Text+"', Estado_civil='"+cmbEstadoCivil.Text+"', Fecha_ing_minerd='"+txtIngreso.Text+"', Id_cargo='"+txtidcargo.Text+"', Id_estudio_ex='"+txtIdEstudiosExtras.Text+"', id_nivel_acad='"+txtIdNivelAcademico.Text+"', Estatus='"+cmbestado.Text+"', foto='"+txtRuta.Text+"', nacimiento='"+txtNacimiento.Text+"', celular='"+txtcedula.Text+"', sexo='"+cmbsexo.Text+"' WHERE id_empleado = '" + int.Parse(txtid.Text) + "'");
            }
        ...
        private void btneliminar_Click(object sender, EventArgs e)
        {
            ...
            {
                op.ConsultasSinResultados("delete from empleado where id_empleado = '" + txtid.Text + "'");
       
            }
            this.Close();
             }

        private void cmbEstudiosExtras_TextChanged(object sender, EventArgs e)
        {
            Operaciones op = new Operaciones();
        ...
        private void cmbNivelAcademico_TextChanged(object sender, EventArgs e)
        {
            Operaciones op = new Operaciones();
